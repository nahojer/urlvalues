...
// encoding.TextUnmarshaller interface is used to decode the URL value.
//
...
// customizing how URL values should be parsed by providing layouts understood
// by time.Parse.
//
...
//
// The parsing of time.Time fields is extended to support a "now" based parsing.
// It parses the URL value "now" to time.Now(). Furthermore, it extends this
